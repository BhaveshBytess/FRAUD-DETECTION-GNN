...
GraphSAGE (SAmple and aggreGatE) uses neighborhood sampling for scalability
and better generalization compared to full-batch GCN.
"""
...
class GraphSAGE(nn.Module):
    ...
    Uses SAGEConv layers with mean aggregation.
    """
...
class GraphSAGETrainer:
    """
    Trainer for GraphSAGE model with early stopping.
    """
